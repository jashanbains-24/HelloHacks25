...
export default function Home() {
  ...
  async function onFindJobsFromCourses(e) {
    ...
    const picked = (allCourses || []).filter((c) =>
      codesLC.includes(String(c.code).toLowerCase().trim())
    );
    ...
    <>
      ...
      <div
        style={{
          padding: "2rem",
          maxWidth: 1000,
          margin: "80px auto 0", // space for fixed topbar
          fontFamily: "system-ui, sans-serif",
          color: "#111", // light theme text
      ...
      >
        ...
        {loading && <div style={{ color: "#6b7280" }}>Loading jobs…</div>}
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 16 }}>
            ...
            >
              <h3 style={{ marginTop: 0, marginBottom: 10 }}>
                Recommended UBC courses (by overlap)
              </h3>
              {matchedCourses.length ? (
                ...
                <div style={{ color: "#6b7280" }}>
                  No course recommendations yet. Add courses with skills overlapping:{" "}
                  <i>{fmtSkills(jobSkills)}</i>.
                </div>
              )}
            </div>
          </div>
        ...
        {/* Divider */}
        <div style={{ margin: "32px 0", height: 1, background: "#e5e7eb" }} />
        ...
        <form
          onSubmit={onFindJobsFromCourses}
        ...
        >
          ...
          {yourSkills.length ? (
            fmtSkills(yourSkills)
          ) : (
            <span style={{ color: "#6b7280" }}>
              No skills yet — add valid course codes.
            </span>
          )}
        </div>
                ...
                return (
                  <li
                    ...
                    style={{
                      ...
                      borderRadius: 12,
                      border: "1px solid #e5e7eb",
                      background: tint, // keeps the green/red hint
                    }}
                  >
                    <div
                      style={{
